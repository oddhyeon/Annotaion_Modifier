import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QSlider, QPushButton, QFileDialog, QMessageBox
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.button_delete_object.clicked.connect(self.show_delete_confirmation)
