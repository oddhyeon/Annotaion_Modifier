...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.line_edit_cuboid_id.setGeometry(130, 230, 30, 30)
        self.line_edit_cuboid_id.setPlaceholderText("ID")  # 미리 보이는 힌트 텍스트
